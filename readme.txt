...
A versatile plugin for WordPress, simplifying website cleaning and optimization.
...
* Disable and delete plugins (except this one)
...
== Screenshots ==
1. The main settings page with task options
2. Warning dialog before executing destructive actions
